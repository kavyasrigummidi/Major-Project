...
document.getElementById('email-form').addEventListener('submit', function (e) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbxy67PcTGEL0mwdckk7422piPtKQRJAIcp0w21kpnrWi1sjXPLaZFiH0RvpB5po7kOW/exec', {
        method: 'POST',
    ...
    .catch(error => {
        // Show error message
        statusMessage.innerText = 'Error. Please try again later.';
